contract;
// contract from https://github.com/FuelLabs/sway-standards/blob/master/examples/src3-mint-burn/single_asset/src/single_asset.sw
...
configurable {
    ...
    NAME: str[9] = __to_str_array("TestToken"),
    /// The symbol of the asset minted by this contract.
    SYMBOL: str[2] = __to_str_array("TT"),
}
